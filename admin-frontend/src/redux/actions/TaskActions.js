...
import { ADD_TASK_FAIL, ADD_TASK_REQUEST, ADD_TASK_SUCCESS, GET_ALL_TASK_FAIL, GET_ALL_TASK_REQUEST, GET_ALL_TASK_SUCCESS, UPDATE_TASK_FAIL, UPDATE_TASK_REQUEST, UPDATE_TASK_SUCCESS } from "../constants/TaskConstants";
  ...
  export const EditTask =  (taskId,task) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.put(
        `https://afetapi.onrender.com/api/tasks/${taskId}/update`,task
      );
