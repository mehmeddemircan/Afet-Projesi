...
export const updateUserLocationReducer = (
  ...
  switch (action.type) {
    case UPDATE_LIVE_LOCATION_REQUEST : 
        return {
          ...state ,
          loading : true ,
        }
